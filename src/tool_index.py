...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "generate_video": "Generate an AI video from a text prompt using Seedance 2. Specify duration (5 or 10s), resolution (720p/1080p), aspect ratio. Clips, animations, motion.",
